...
export default function App() {
  ...
  return <div className={`acg-app ${darkMode ? 'acg-dark' : ''}`}>
    <DesktopTerminal {...{ market, selectedSymbol, selectSymbol, timeframe, setTimeframe, chartType, setChartType, volume, changeVolume, terminalTab, setTerminalTab, quickOrder, filteredMarkets, favorites, toggleFavorite, watchFilter, setWatchFilter, search, setSearch, settingsOpen, setSettingsOpen }} />
    <MobileTerminal {...{ view: mobileView, market, selectedSymbol, setSelectedSymbol: selectSymbol, timeframe, setTimeframe, volume, changeVolume, pulse, quickOrder, chartType, setChartType, filteredMarkets, favorites, toggleFavorite, watchFilter, setWatchFilter, search, setSearch, setOrderSide, setOrderOpen, terminalTab, setTerminalTab, darkMode, toggleTheme, goMobile }} />
...
function DesktopTerminal({ market, selectedSymbol, selectSymbol, timeframe, setTimeframe, chartType, setChartType, volume, changeVolume, terminalTab, setTerminalTab, quickOrder, filteredMarkets, favorites, toggleFavorite, watchFilter, setWatchFilter, search, setSearch, settingsOpen, setSettingsOpen }) {
...
function MobileTerminal({ view, market, selectedSymbol, setSelectedSymbol, timeframe, setTimeframe, volume, changeVolume, pulse, quickOrder, chartType, setChartType, filteredMarkets, favorites, toggleFavorite, watchFilter, setWatchFilter, search, setSearch, setOrderSide, setOrderOpen, terminalTab, setTerminalTab, darkMode, toggleTheme, goMobile }) {
