  ...
  return (
    <section className="min-h-[calc(100dvh-98px)] px-3 pb-6 pt-3">
      <header className="flex items-start justify-between gap-3 pb-3">
        <div><p className="text-[9px] font-bold uppercase tracking-[0.16em] text-[#5f7488]">Durable account record</p><h1 className="mt-1 text-[26px] font-black tracking-[-0.045em] text-[#f5f8fb]">History</h1><p className="mt-1 max-w-[290px] text-[10px] leading-relaxed text-[#718397]">{durable.loaded ? 'Loaded from paginated backend orders and deals.' : durable.error ? 'Backend history is unavailable; recent realtime fills remain visible.' : 'Loading durable trading history…'}</p></div>
