  ...
  return (
    <div className="flex items-center gap-2.5 px-3 pb-3 pt-3 sm:px-4 sm:pt-4">
      ...
      <button
        ...
        onClick={onFavorite}
        className={`grid size-8 shrink-0 place-items-center rounded-md border border-white/[0.08] bg-[#080808] shadow-[inset_0_1px_rgba(255,255,255,0.02)] active:scale-95 ${favorite ? 'text-[#ffc856]' : 'text-[#667b8f]'}`}
      >
