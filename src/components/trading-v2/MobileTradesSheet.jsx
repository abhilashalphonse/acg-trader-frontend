        ...
        <header className="shrink-0 border-b border-white/[0.06] bg-[#080808] px-3 pt-3">
          <div className="flex items-start justify-between gap-3 pb-2.5">
            <div>
              ...
              <p className="mt-0.5 text-[8px] text-[#667b8e]">Positions, pending orders and executed history.</p>
            </div>
          ...
          <div className="grid grid-cols-3">
            {[
              ...
              <button
                ...
                type="button"
                onClick={() => setTab(id)}
                className={`relative h-9 text-[8px] font-black uppercase tracking-[0.07em] ${tab === id ? 'text-[#e8f2f8]' : 'text-[#62778a]'}`}
              >
                {label}
