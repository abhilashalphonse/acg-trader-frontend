                  ...
                  <div className="space-y-2 border-t border-[#172a38] bg-[#07111a] p-2.5">
                    ...
                    <div className="rounded-xl border border-[#183144] bg-[#091923] p-2.5">
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2"><ShieldCheck size={15} className={position.trailingEnabled ? 'text-[#57ccff]' : 'text-[#688095]'}/><div><b className="block text-[10px] text-[#d5dfe7]">Trailing Stop</b><span className="mt-0.5 block text-[8px] text-[#667b8f]">Automatically moves the stop as price advances</span></div></div>
