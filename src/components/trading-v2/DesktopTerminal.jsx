        ...
        <div className="acg-desktop-chart-toolbar flex min-w-0 shrink-0 items-center border-l border-white/[0.06] bg-transparent px-2.5">
          ...
          <div className="ml-1.5 flex h-full shrink-0 items-center gap-1.5">
            ...
            <div className="relative">
              ...
              {indicatorPanelOpen && (
                <div className="absolute right-0 top-8 z-[110] w-[480px] max-w-[calc(100vw-32px)] max-h-[min(720px,calc(100dvh-100px))] overflow-y-auto rounded-lg border border-white/[0.10] bg-[#0B0D0F]/98 p-3 shadow-[0_24px_70px_rgba(0,0,0,.68)] backdrop-blur-xl [scrollbar-width:thin]">
